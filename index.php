...
<body class="body__wrapper">
    ...
    <div id="back__preloader">
        ...
        <div class="back__loader_logo">
            <img loading="lazy"  src="img/logo1.png" alt="Preload">
        </div>
    </div>
    <!-- pre loader area end -->
    ...
    <main class="main_wrapper overflow-hidden">
        ...
        <div class="herobannerarea herobannerarea__box">
                        ...
                        <div class="herobannerarea__content__wraper">
                            ...
                            <div class="herobannerarea__title">
                                ...
                                <div class="herobannerarea__title__heading__2">
                                    <h2>Your One-Stop Solution for Education</h2>
                                </div>
                            </div>

                            <div class="herobannerarea__text">
                                <p>We assist with registration, academic research, professional training, and payment processing with ease and efficiency.</p>
                            </div>
                            <div class="hreobannerarea__button">
                                <a class="herobannerarea__button__1" href="login.html">Get Started</a>
                                <a class="herobannerarea__button__2" href="#">Explore Our Services
            ...
            <div class="herobannerarea__icon">
                <img loading="lazy"  class="hero__icon__1" src="img/register/register__2.png" alt="photo">
                <img loading="lazy"  class="hero__icon__2" src="img/herobanner/herobanner__6.png" alt="photo">
                <img loading="lazy"  class="hero__icon__3" src="img/herobanner/herobanner__7.png" alt="photo">
                <img loading="lazy"  class="hero__icon__4" src="img/herobanner/herobanner__7.png" alt="photo">
            </div>
        </div>
                ...
                <div class="row" data-aos="fade-up">
                    <div class="brandarea__wraper brandarea__wraper__2">
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy"  src="img/brand/brand1.jpg" alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy"  src="img/brand/brand2.png" alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy"  src="img/brand/brand3.png" alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy"  src="img/brand/brand4.png" alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy"  src="img/brand/brand5.jpg" alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy"  src="img/brand/brand2.png" alt="brand"></a>
                        </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        <div class="about__right__wraper__2">
                            <div class="educationarea__img" data-tilt>
                                <img loading="lazy"  class="aboutarea__2__img__1" src="img/about/about_2.png" alt="education">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        ...
                        <div class="aboutarea__content__wraper">
                            ...
                            <div class="aboutarea__headding heading__underline">
                                <h2>Welcome to Edunyst</h2>
                            </div>
                            <div class="aboutarea__para aboutarea__para__2">
                                <p>15+ Years of Expertise in Simplifying Academic and Professional Services. Achieving your goals can be simple with our streamlined services, designed to help students and professionals succeed effortlessly</p>
                            </div>
                            <div class="aboutarea__list__2">
                                <ul>
                                    <li>
                                        <i class="icofont-check"></i>Committed to making complex processes simple 
                                    </li>

                                    <li>
                                        <i class="icofont-check"></i> Discover diverse services that simplify your journey
                                    </li>

                                    <li>
                                        <i class="icofont-check"></i> We’re dedicated to delivering excellence and efficiency 
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="populerarea__content__wraper__2">
                            <div class="section__title ">
                                <div class="section__title__button">
                                    <div class="default__small__button"> Our Services</div>
                                </div>
                                <div class="section__title__heading">
                                    <h2>Explore our services
                                        <br> Solution designed for you</h2>
                                </div>
                            </div>

                            <div class="populerarea__content__2">
                                <p class="populerarea__para__1">We offer streamlined services in in registration, research, professional training and payments to simplify your academic and professional journey</p>
                                <p class="populerarea__para__2">We provide comprehensive services, including admission processing for local and international schools, research support such as data analysis and plagiarism checks, professional training in Product management, project management, efficient payment management for fees, certificates, transcript and more.
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up">
                                <div class="single__service">
                                    ...
                                    <div class="service__content service__content__2">
                                        <h3><a href="course-details.html">Registration</a></h3>
                                        <p>Information on  admission processes </p>
                                    </div>
                                ...
                                <rect x="28" y="11.5198" width="8" height="0.993319" fill="#FFB31F"/>
                                    ...
                                    <div class="service__content service__content__2">
                                        <h3><a href="course-details.html">Research</a></h3>
                                        <p>Articles/Journals/Project etc.</p>
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M26.9989 7.6293L23.05 18.137L20.3744 15.4678C15.622 19.6266 9.96272 22.5976 3.63238 24.2568C1.36694 24.9297 0.353173 21.6176 2.74495 21.0505C8.47735 19.533 13.5443 16.8156 17.8363 13.1279L15.5453 10.8879L26.9989 7.6293Z" fill="#FFB31F"/>
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M63.3775 44.4535C54.8582 58.717 39.1005 53.2202 23.1736 47.5697C7.2467 41.9192 -5.18037 32.7111 3.33895 18.4477C11.8583 4.18418 31.6595 -2.79441 47.5803 2.85105C63.5011 8.49652 71.8609 30.2313 63.3488 44.4865L63.3775 44.4535Z" fill="#5F2DED" fill-opacity="0.05"/>
                                    ...
                                    <div class="service__content service__content__2">
                                        <h3><a href="course-details.html">Payments</a></h3>
                                        <p>School fees, Transcript etc. </p>
                                    </div>
                                    <div class="service__button">
                                        <a href="#">Explore
                            <i class="icofont-long-arrow-right"></i>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="section__title__2" data-aos="fade-up">
                            ...
                            <div class="section__title__heading__2 section__title__heading__3 heading__fontsize__2">
                                <h2>Client Testimonial About Our Service</h2>
                            </div>
                        </div>
                        ...
                        <div class="testimonial__slider__active__3" data-aos="fade-up">
                            ...
                            <div class="testimonialarea__paragraph__3 ">
                                <p class="testimonial__quote"><i class="icofont-quote-left quote__left"></i>Their research assistance is top-notch. From plagiarism checks to proofreading, they helped me perfect my thesis. Highly recommend!<i class="icofont-quote-right quote__right"></i></p>

                                <div class="testimonialarea__person__3">
                                    <div class="testimonial__img__3">
                                        <img loading="lazy"  src="img/testimonial/testi_2.jpg" alt="">
                                    </div>
                                    <div class="testimonial__name">
                                        <h6><a href="#">Oyekanmi Philip Ololade</a></h6>
                            ...
                            <!-- <div class="testimonialarea__paragraph__3 ">
                                <p class="testimonial__quote"><i class="icofont-quote-left quote__left"></i>This platform is a lifesaver! It handled my convocation and alumni fee payments without any hassles. Very convenient<i class="icofont-quote-right quote__right"></i></p>

                                <div class="testimonialarea__person__3">
                                    <div class="testimonial__img__3">
                                        <img loading="lazy"  src="img/testimonial/testi_1.jpg" alt="">
                                    </div>
                                    <div class="testimonial__name">
                                        <h6><a href="#">Pious victory</a></h6>
                            ...
                            <div class="testimonialarea__paragraph__3 ">
                                <p class="testimonial__quote"><i class="icofont-quote-left quote__left"></i> Handling payments for my school fees and transcripts has never been easier. Their team is fast, reliable, and trustworthy.<i class="icofont-quote-right quote__right"></i></p>
                                ...
                                <div class="testimonialarea__person__3">
                                    ...
                                    <div class="testimonial__name">
                                    <h6><a href="#">Abdulkareem salimah</a></h6>
                            ...
                            <div class="testimonialarea__paragraph__3 ">
                                <p class="testimonial__quote"><i class="icofont-quote-left quote__left"></i>The platform made my school admission process so seamless! I got updates every step of the way, and I couldn’t be happier with the service.<i class="icofont-quote-right quote__right"></i></p>

                                <div class="testimonialarea__person__3">
                                    <div class="testimonial__img__3">
                                        <img loading="lazy"  src="img/testimonial/testi_3.jpg" alt="">
                                    </div>
                                    <div class="testimonial__name">
                                    <h6><a href="#">Pious victory</a></h6>
                                        <span>Business Administration</span>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        <div class="testimonial__group__img" data-tilt>
                            <img loading="lazy"  src="img/testimonial/testi__group__1.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                        <div class="single__blog__wraper">
                            <div class="single__blog__img">
                                <img loading="lazy"  src="img/blog/blog_1.jpg" alt="blog">
                            ...
                            <div class="single__blog__content">
                                <p>29 april 2025</p>
                                <h4> <a href="#">Resumption for all Federal Polytechnic Ilaro student </a></h4>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                        <div class="single__blog__wraper">
                            <div class="single__blog__img">
                                <img loading="lazy"  src="img/blog/blog_2.jpg" alt="blog">
                                <div class="single__blog__button">
                                    <a class="default__button" href="#">Story</a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                        <div class="single__blog__wraper">
                            <div class="single__blog__img">
                                <img loading="lazy"  src="img/blog/blog_3.jpg" alt="blog">
                                <div class="single__blog__button">
                                    <a class="default__button" href="#">Story</a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        <div class="registerarea__wraper">
                            <div class="section__title registerarea__section__title">
                                <div class="section__title__button">
                                    <div class="default__small__button">Chat with Us</div>
                                </div>
                                <div class="section__title__heading heading__underline">
                                    <h2>Need Assistance? We’re Here to Help You!
                                    </h2>
                                </div>
                            </div>
                            <div class="registerarea__content">
                                <div class="registerarea__video">
                                    <div class="video__pop__btn">
                                        <a class="video-btn" href=""> <img loading="lazy"  src="img/icon/video.png" alt=""></a>
                                    </div>
                                    <div class="registerarea__para">
                                        <p>Have questions about our services or need guidance? Use our chat feature to get instant support from our friendly team</p>
                                    </div>
                        ...
                        <div class="registerarea__form">
                            ...
                            <form action="#">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <input class="register__input" type="text" placeholder="Phone number">
                                    </div>
                                </div>
                                <input class="register__input" type="text" placeholder="School">
...
<!-- Mirrored from html.themewin.com/edurock-preview/edurock/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 Nov 2024 17:08:30 GMT -->
</html>