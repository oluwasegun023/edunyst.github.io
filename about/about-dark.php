...
<!-- Mirrored from html.themewin.com/edurock-preview/edurock/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 Nov 2024 17:01:26 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="body__wrapper">
    ...
    <div id="back__preloader">
        ...
        <div class="back__loader_logo">
            <img loading="lazy"  src="img/logo.jpg" alt="Preload">
        </div>
    </div>
    <!-- pre loader area end -->
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="topbar__left">
                            <ul>
                                <li>
                                    Call Us: +234 803 918 6405
                                </li>
                                <li>
                                    - Mail Us: edunyst@gmail.com
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <div class="topbar__right">
                            ...
                            <div class="topbar__text">
                                <p>UBA market,Federal Polytechnic Ilaro, Ogun State.</p>
                            </div>
                                ...
                                <nav>
                                    <ul>
                                        ...
                                        <li class="mega__menu position-static">
                                            <a class="headerarea__has__dropdown" href="index.html">Home</a>          
                                        </li>

                                        <li class="mega__menu position-static">
                                            <a class="headerarea__has__dropdown" href="about.html">About Us</a>
                                        </li>


                                        <li class="mega__menu position-static">
                                            <a class="headerarea__has__dropdown" href="blog.html">Service</a>
                                        </li>
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="single__event__wraper single__award" data-aos="fade-up">
                                                <div class="eventarea__img">
                                                    <img loading="lazy"  src="img/about/award-1.jpg" alt="event">
                                                </div>
                        ...
                        <div class="single__testimonial__wraper">
                            <div class="single__testimonial__inner">
                                <div class="testimonial__img">
                                    <img loading="lazy"  src="img/testimonial/testi_1.png" alt="testi">
...
<!-- Mirrored from html.themewin.com/edurock-preview/edurock/about-dark.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 Nov 2024 17:11:40 GMT -->
</html>